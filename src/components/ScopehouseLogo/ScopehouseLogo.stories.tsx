...
import { ScopehouseLogo } from './ScopehouseLogo'

const meta = {
  title: 'Components/ScopehouseLogo',
  component: ScopehouseLogo,
...
} satisfies Meta<typeof ScopehouseLogo>
...
export const AllSizes: Story = {
  ...
  render: (args) => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', alignItems: 'flex-start' }}>
      <ScopehouseLogo {...args} size="sm" />
      <ScopehouseLogo {...args} size="md" />
      <ScopehouseLogo {...args} size="lg" />
    </div>
  ),
...
export const AllVariants: Story = {
  ...
  render: (args) => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', alignItems: 'flex-start' }}>
      <ScopehouseLogo {...args} variant="color" />
      <ScopehouseLogo {...args} variant="void" />
    </div>
  ),
}
...
export const AllVariantsDark: Story = {
  ...
  render: (args) => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', alignItems: 'flex-start' }}>
      <ScopehouseLogo {...args} variant="dark" />
      <ScopehouseLogo {...args} variant="paper" />
    </div>
  ),
}
...
export const AllLockups: Story = {
  ...
  render: (args) => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '32px', alignItems: 'flex-start' }}>
      <ScopehouseLogo {...args} lockup="horizontal" />
      <ScopehouseLogo {...args} lockup="stacked" />
      <ScopehouseLogo {...args} lockup="mark-only" size="lg" />
      <ScopehouseLogo {...args} lockup="wordmark-only" />
    </div>
  ),
  args: { variant: 'color' },
}
